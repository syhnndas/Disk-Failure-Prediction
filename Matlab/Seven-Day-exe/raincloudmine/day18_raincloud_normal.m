...
output_filename = 'Rain_cloud_normal.png'; % 更新输出文件名
...
% 绘制箱型图 (水平方向)
h_boxplot = boxplot(data, 'Labels', group_names, 'Notch', 'off', ... % <-- 'on' 修改为 'off'移除缺口
...
box off; grid off
% --- 5. 设置标题和轴标签 ---
title('Rain cloud normal', 'FontName', 'Times New Roman', ... % 更新标题
